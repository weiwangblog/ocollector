...
sub gen_lib {
    my @want = qw{Common ServiceMonitor/Memcached AccountServer/Cache AccountServer/StatisticDetails CloudStat/Memory CloudStat/Cpu CloudStat/Disk Nginx/ErrorLog AccountServer/DBComErr Tcpbasic/Windows};
