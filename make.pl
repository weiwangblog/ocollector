...
sub gen_lib {
    my @want = qw{ Common ServiceMonitor/Memcached AccountServer/Cache AccountServer/StatisticDetails Nginx/ErrorLog IIS/Error2 AccountServer/DBComErr AccountServer/AC Tcpbasic/Windows Nginx/RegionLatency CloudStat/Wrapper StorageStat/Wrapper };
